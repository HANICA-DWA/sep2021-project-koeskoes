      ...
      <div className="container text-center rounded p-3 bg-light mt-4 mb-4">
        <div className="row mb-4">
          <div className="col-5 text-start">
            <button className="btn btn-primary" onClick={() => navigate("/receiver/text-reaction")}>
        ...
        <p className="px-3">Om een videoreactie te versturen drukt u op de knop "opnemen" of upload u een video.</p>           
        <div className="row mt-4 mb-5 text-danger">
          Hier komt de componenten vanuit CreateVideoPage van /Buyer/CreateVideoPage.jsx
        </div>
