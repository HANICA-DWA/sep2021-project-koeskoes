...
function CheckOutPage() {
  ...
  const checkFullName = () => {
    ...
    if (firstNameBuyer === null || firstNameBuyer.trim() === "") {
      return {
        status: "error",
        message: "De voornaam mag niet leeg zijn. Een voornaam moet minimaal 1 teken bevatten.",
      };
    }
    ...
    if(lastNameBuyer === null || lastNameBuyer.trim() === "") {
      return {
        status: "error",
        message: "De achternaam mag niet leeg zijn. Een achternaam moet minimaal 1 teken bevatten.",
      }
    }
    ...
    if (firstNameBuyer.length > maxLength) {
      return {
        status: "error",
        message:
          `De voornaam is te lang. De voornaam mag maximaal ${maxLength} karakters lang zijn.`,
      };
    }
    ...
    if (lastNameBuyer.length > maxLength) {
      return {
        status: "error",
        message:
          `De achternaam is te lang. De achternaam mag maximaal ${maxLength} karakters lang zijn.`,
      };
    }
  ...
  const checkEmail = () => {
    ...
    if (emailBuyer === null || emailBuyer.trim() === "") {
      return {
        status: "error",
        message: "E-mailadres mag niet leeg zijn. Een e-mailadres moet minimaal 1 teken bevatten.",
      };
    }
